...
namespace FastColoredTextBoxNS
{
    ...
    public class TextStyle : Style
    {
        ...
        public override bool Equals(object obj)
        {
            if(obj is TextStyle)
            {
                var st = obj as TextStyle;
                return
                    (
                        (st.ForeBrush != null && ForeBrush != null && (st.ForeBrush as SolidBrush).Color == (ForeBrush as SolidBrush).Color)
                        || 
                        (st.ForeBrush == null && ForeBrush == null)
                    )
                    && (
                        (st.BackgroundBrush != null && BackgroundBrush != null && (st.BackgroundBrush as SolidBrush).Color == (BackgroundBrush as SolidBrush).Color)
                        || 
                        (st.BackgroundBrush == null && BackgroundBrush == null)
                        )
                    && st.FontStyle == FontStyle
                    ; 
                    //&& st.stringFormat.Equals(stringFormat);
            }
